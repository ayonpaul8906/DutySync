      ...
      const unsubTasks = onSnapshot(qTasks, (taskSnap) => {
        ...
        const filtered = allTasks
          ...
          .map((t) => ({
            ...t,
            driverName:
              drivers.find((d) => d.id === t.driverId)?.name || "Not Assigned",
          }));
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div className="flex items-center gap-4">
            <button
              ...
              className="p-3 bg-white rounded-2xl border border-slate-200 hover:shadow-md transition-all"
            >
              <MdArrowBack size={24} />
            </button>
            <div>
              <h1 className="text-3xl font-black text-slate-900 tracking-tight">
                Daywise <span className="text-indigo-600">Report</span>
              </h1>
                ...
                tasks.map((task) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 font-black text-slate-900 text-sm">
                      {task.closingKm !== undefined &&
                      task.openingKm !== undefined
                        ? `${task.closingKm - task.openingKm} KM`
                        : "--"}
                    </td>
                  </tr>
                ))
